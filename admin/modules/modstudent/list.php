<?php
  ...
  <div class="row">
      <div class="col-lg-12"> 
            <h3 >List of Student <small>|  <label class="label label-xs" style="font-size: 12px"><a href="index.php?view=add">  <i class="fa fa-plus-circle fw-fa"></i> New</a></label> |</small></h3> 
